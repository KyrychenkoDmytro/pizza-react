import style from './CartNotEmpty.module.scss';

const CartNotEmpty = () => {
    return (
        <div className={style.CartNotEmpty}>
            ...
            <div className={style.wrapper_items}>
                ...
                <div className={style.item_remove}>
                    <button className={`${style.button} button button--outline button--circle`}>
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={style.cart_footer}>
                <div className={style.all_order_info}>
                    <span> Всего пицц: <b>3 шт.</b> </span>
                    <span> Сумма заказа: <b>900 ₴</b> </span>
                </div>
                <div className={style.buttons_wrapper}>
                    <a href="/" className={`button button--outline ${style.go_back_btn}`}>
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 13L1 6.93015L6.86175 1" stroke="#D3D3D3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <span>Go back</span>
                    </a>
                    <div className={`button ${style.pay_btn}`}>
                        <span>Pay now</span>
                    </div>
                </div>
            </div>
